...
def run_initialization():
    try:
        ...
        # Сначала применяем миграции для встроенных приложений
        print("🔄 Применение системных миграций...")
        call_command("migrate", "auth", "contenttypes", "sessions", interactive=False)

        # Затем создаем миграции для нашего приложения
        print("🔄 Создание миграций для main...")
        call_command("makemigrations", "main", interactive=False)

        # Применяем миграции для нашего приложения
        print("🔄 Применение миграций для main...")
